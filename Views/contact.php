...
<head>
    ...
    <link href="contenu/css/mon-blog.min.css" rel="stylesheet">
...
<body>
    ...
    <header class="masthead" style="background-image: url('contenu/img/contact-bg.jpg')">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <div class="site-heading">
                        ...
                        <span class="subheading">Pour toutes vos questions !</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    <ul class="list-inline text-center">
                        <li class="list-inline-item">
                            <a href="https://openclassrooms.com/fr/dashboard/courses">
                        ...
                        <li class="list-inline-item">
                            <a href="https://www.facebook.com/hassan.mouhieddine/">
                                <span class="fa-stack fa-lg">
                                    <i class="fas fa-circle fa-stack-2x"></i>
                        ...
                        <li class="list-inline-item">
                            <a href="https://github.com/mouhied/">
                                <span class="fa-stack fa-lg">
                                    <i class="fas fa-circle fa-stack-2x"></i>
